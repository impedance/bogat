...
- **Валидации:** Zod (или строгая типизация через TS).
...
- [ ] Nuxt 3 инициализация, Tailwind, Pinia.
- [ ] `@vite-pwa/nuxt`, манифест, базовый SW.
- [ ] Заготовки страниц и навигации.
...
> **Итого MVP:** 1–2 недели спокойной сборки одним разработчиком.
...
## 13) Тестирование
- Юнит‑тесты для `useMoney`, селекторов баланса.
- E2E (минимум): добавить→отфильтровать→экспорт→импорт.
