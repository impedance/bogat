...
## 0) Текущее состояние (2025-11-17)
- Общий прогресс: **≈55 % выполнено**, **≈45 % осталось** (Этапы 0–1 закрыты, Этап 2 в работе — транзакции готовы для создания/фильтров/ленты, добавлены страницы счетов/категорий).
...
| 2 | Транзакции и расчёты | ▶️ В работе (создание/фильтры/лента готовы, UI счетов/категорий подхватывает сторы; осталось редактирование/удаление и MoneyInput/быстрые суммы) | 70 % |
| 3 | PWA и офлайн‑проверка | ⏳ Не начат | 0 % |
| 4 | JSON бэкап/импорт | ⏳ Не начат | 0 % |
| 5 | Полировка UI/A11y | ⏳ Не начат | 0 % |

- Ближайший фокус: завершить UI Этапа 2 (редактирование/удаление транзакций, MoneyInput/быстрые суммы, дашборд балансов) и начать подготовку к экспорт/импорт сценарию.
- Выявленные пробелы:
  - нет переработанного дашборда и страницы настроек (`settings.vue`), MoneyInput/быстрых сумм, редактирования/удаления транзакций;
...
- [ ] Редактирование/удаление транзакций, маска MoneyInput, быстрые суммы и дашборд с агрегатами балансов.
