...
- Общий прогресс: **≈20 % выполнено**, **≈80 % осталось** (из 6 этапов готов 1 полностью и небольшая часть этапа 1).
- Этап 0 — ✅ Завершён.
- Этап 1 — ⚙️ В работе (~20 %): готовы типы и денежный helper `useMoney` + тесты, предстоит Dexie + репозитории + сторы.
- Этапы 2–5 — ⏳ Не начаты.
