...
- Общий прогресс: **≈30 % выполнено**, **≈70 % осталось** (из 6 этапов завершён Этап 0 и закрыты 2/3 пунктов Этапа 1).
...
| 1 | Данные и CRUD | ⚙️ Dexie + seed + репозитории готовы, ждём Pinia-сторов и селекторов | ~65 % |
| 2 | Транзакции и расчёты | ⏳ Не начат | 0 % |
| 3 | PWA и офлайн‑проверка | ⏳ Не начат | 0 % |
| 4 | JSON бэкап/импорт | ⏳ Не начат | 0 % |
| 5 | Полировка UI/A11y | ⏳ Не начат | 0 % |

- Ближайший фокус: довести Pinia-сторы/селекторы поверх готовых репозиториев, затем перейти к формам и фильтрам Этапа 2.
