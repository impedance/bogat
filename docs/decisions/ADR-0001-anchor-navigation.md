...
<!-- AICODE-WHY: DECISION/ADR-0001 — README становится “картой” репозитория, а AICODE-якоря дают стабильные точки входа для `rg` и агентов; ref: docs/agent/anchor-scheme.md [2025-12-28] -->
